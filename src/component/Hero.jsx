        ...
        <div>
          <article className="m-auto min-w-[300px] max-w-[500px] flex flex-col lg:items-start">
            ...
            <p className="px-5 text-base font-medium text-justify overflow-auto h-[180px] lg:px-0 lg:overflow-hidden lg:h-full">
              I am a career switcher who participated in Generation Thailand -
              Junior Software Developer program. I have recently worked as a
              Software Developer at Maholan Company. My technical skills include
              React.js, useForm, MUI, Nest.js, TypeORM, and SQL. My
              responsibilities involved gathering requirements from Business
              Analysts (BAs) to create data entry forms and display information
              according to specified formats and functions. I developed APIs to
              retrieve and create necessary data
            </p>
          </article>
        </div>
      </div>
