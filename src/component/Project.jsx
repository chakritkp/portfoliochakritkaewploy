  ...
  return (
    ...
    >
      <div>
        ...
        <a href="https://colmaracademy07chakritguy.vercel.app/" target="_blank">
          <div className="flex mx-3 mb-5">
            ...
            <div className="w-1/3 mx-auto">
              <h3 className="text-lg font-semibold px-5">Colmar Academy</h3>
        ...
        >
          <div className="flex mx-3">
            ...
            <div className="w-1/3 mx-auto">
              <h3 className="text-lg font-semibold px-5 ">Generation Thailand</h3>
              <h3 className="text-lg font-semibold px-5 ">React - Assessment</h3>
